...
```{r simplt-pars1, fig.cap="Bias in parameters for uncensored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_a_pars_full.png"))
```

```{r simplt-pars2, fig.cap="Bias in parameters for censored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-pars3, fig.cap="Bias in parameters for uncensored simulations using logit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_c_pars_full.png"))
```

```{r simplt-pars4, fig.cap="Bias in parameters for censored simulations using logit link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-cdf1, fig.cap="Bias in conditional CDF for uncensored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_b_cdf_full.png"))
```

```{r simplt-cdf2, fig.cap="Bias in conditional CDF for censored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-mn1, fig.cap="Bias in conditional mean for uncensored simulations using probit link", fig.align='center', out.width='90%',eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_b_mn_full.png"))
```

```{r simplt-mn2, fig.cap="Bias in conditional mean for censored simulations using probit link", fig.align='center', out.width='90%',eval=FALSE}
...
```{r simplt-mn3, fig.cap="Bias in conditional mean for uncensored simulations using logit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_c_mn_full.png"))
```

```{r simplt-mn4, fig.cap="Bias in conditional mean for censored simulations using logit link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-med1, fig.cap="Bias in conditional median for uncensored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_b_med_full.png"))
```

```{r simplt-med2, fig.cap="Bias in conditional median for censored simulations using probit link", fig.align='center', out.width='90%',eval=FALSE}
...
```{r simplt-q20-1, fig.cap="Bias in conditional 20th percentile for uncensored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_b_q20_full.png"))
```

```{r simplt-q20-2, fig.cap="Bias in conditional 20th percentile for censored simulations using probit link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-q20-3, fig.cap="Bias in conditional 20th percentile for uncensored simulations using logit link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_c_q20_full.png"))
```

```{r simplt-q20-4, fig.cap="Bias in conditional 20th percentile for censored simulations using logit link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r elpdtab1, results = 'asis', eval=FALSE}
...
```{r elpdtab2, results = 'asis', eval=FALSE}
