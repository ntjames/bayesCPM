...
To summarize the simulations, we examine the average percent bias of the posterior median for parameters $\beta_1$ and $\beta_2$ and posterior median $\gamma_j$ parameters corresponding to $y$ values spaced across the range of the data. For the simulations based on 1. 
$\boldsymbol{y}=\{y_1=e^{-1},y_2=e^{-0.33},y_3=e^{0.5},y_4=e^{1.33},y_5=e^2\}$, for those based on 2.
$\boldsymbol{y}=\{y_1=e^{-0.5},y_2=e^{0},y_3=e^{0.5},y_4=e^{1},y_5=e^{1.5}\}$ and for 3.
$\boldsymbol{y}=\{y_1=-0.3,y_2=0,y_3=0.5,y_4=1.5,y_5=2.5\}$. For the censored outcomes, estimates are only available for the uncensored values of $\boldsymbol{y}$.

!!! Start here !!!

We also calculate average percent bias of the conditional CDF for $\boldsymbol{y}$ when $X_1=1$ and $X_2=1$, the conditional median at $(X_1=1,X_2=1)$ and $(X_1=1,X_2=0)$, and the conditional mean and 20$^{th}$ percentile for the uncensored outcome simulations.
