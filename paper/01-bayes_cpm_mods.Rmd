...
```{r simplt-mn5, fig.cap="Bias in conditional mean for uncensored simulations using loglog link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_d_mn_full.png"))
```

```{r simplt-mn6, fig.cap="Bias in conditional mean for censored simulations using loglog link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-med5, fig.cap="Bias in conditional median for uncensored simulations using loglog link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_d_med_full.png"))
```

```{r simplt-med6, fig.cap="Bias in conditional median for censored simulations using loglog link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-q20-5, fig.cap="Bias in conditional 20th percentile for uncensored simulations using loglog link", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_d_q20_full.png"))
```

```{r simplt-q20-6, fig.cap="Bias in conditional 20th percentile for censored simulations using loglog link", fig.align='center', out.width='90%', eval=FALSE}
...
```{r simplt-samptime1, fig.cap="Per chain MCMC sampling time for scenario 1", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_a_MCMC_sample_times.png"))
```

```{r simplt-samptime2, fig.cap="Per chain MCMC sampling time for scenario 1 - 2nd run", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_b_MCMC_sample_times.png"))
```

```{r simplt-samptime3, fig.cap="Per chain MCMC sampling time for scenario 2", fig.align='center', out.width='90%', eval=FALSE}
knitr::include_graphics(file.path(wd,"fig","sim_c_MCMC_sample_times.png"))
```

```{r simplt-samptime4, fig.cap="Per chain MCMC sampling time for scenario 3", fig.align='center', out.width='90%', eval=FALSE}
