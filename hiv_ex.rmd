...
ggsave(file.path(figdir,"il_6_post_v2.tiff"),width=6,height=4,bg='white',dpi=600)
...
ggsave(file.path(figdir,"il_6_post_ct.tiff"),width=6,height=4,bg='white',dpi=600)

plot_grid(pg_il_6_a,pg_il_6_b,nrow=1)
ggsave(file.path(figdir,"il_6_post_est_ct.tiff"),width=8,height=4,bg='white',dpi=600)
...
ggsave(file.path(figdir,"il_6_postpred.tiff"),width=6,height=4,dpi=600)
```
...
ggsave(file.path(figdir,"il_6_trans_v2.tiff"),width=6,height=4,dpi=600)
...
ggsave(file.path(figdir,"il_6_bmi.tiff"),width=6,height=3.5,dpi=600)
```
...
ggsave(file.path(figdir,"il_1_beta_post_v2.tiff"),width=6,height=4,bg='white',dpi=600)
...
ggsave(file.path(figdir,"il_1_beta_post_ct.tiff"),width=6,height=4,bg='white',dpi=600)

plot_grid(pg_il_1_beta_a,pg_il_1_beta_b,nrow=1)
ggsave(file.path(figdir,"il_1_beta_post_est_ct.tiff"),width=8,height=4,bg='white',dpi=600)
...
ggsave(file.path(figdir,"il_1_beta_postpred.tiff"),width=6,height=4,dpi=600)
```
...
ggsave(file.path(figdir,"il_1_beta_trans_v2.tiff"),width=6,height=4,dpi=600)
```
...
ggsave(file.path(figdir,"il_1_beta_bmi.tiff"),width=6,height=3.5,dpi=600)
```
