...
if(sinfo['sysname']=='Windows' & sinfo['user']=='nj115'){
  bayes_cpm_pap_dir <- file.path("C:/Users/nj115/Dropbox/njames/school/PhD/orise_ra/bayes_cpm/paper_Stats_in_Med")
} else if (sinfo['sysname']=='Linux' & sinfo['user']=='nathan') {
  bayes_cpm_pap_dir <- file.path("/home/nathan/Dropbox/njames/school/PhD/orise_ra/bayes_cpm/paper_Stats_in_Med")
}
